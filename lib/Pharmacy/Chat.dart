...
import 'package:pharmacy_app/Pharmacy/PharmaChatBody.dart';
import 'package:pharmacy_app/Pharmacy/PharmaChatHeader.dart';
...
class PharmaChat extends StatelessWidget {
  @override
                ...
                default:
                  if (snapshot.hasError) {
                    ...
                    if (users.isEmpty) {
                      ...
                      return Column(
                        children: [
                          PharmaChatHeader(uusers: users),
                          PharmaChatBody(uusers: users)
                        ],
                      );
                  }
              }
